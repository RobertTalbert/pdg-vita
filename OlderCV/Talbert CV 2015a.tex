...
\begin{itemize}
	...
	\item Talbert, R. (2014) ``Calculus''. Book chapter to appear in \emph{Flipping the College Classroom}, J. Waldrop and M. Bowdon, editors. 
...
\begin{itemize}
\item Talbert, R. (2014) Inverting the transition-to-proof course. To appear in \emph{PRIMUS: Problems, Resources, and Issues in Undergraduate Mathematical Studies}. 
\item Bjorkman, B. and Talbert, R. (2014) Fixed points of columnar transposition ciphers. To appear in \emph{Journal of Discrete Mathematical Sciences and Cryptography}.
...
\begin{itemize}
	\item Talbert, R. (2015) Article on the flipped classroom, title TBA. To appear in \emph{Faculty Focus}, \url{http://www.facultyfocus.com/}. 
...
Author of \textbf{Casting Out Nines} blog (\url{http://rtalbert.org/blog}), on mathematics, teaching, and technology. The blog was a sponsored publication of the \emph{Chronicle of Higher Education} until August 2015 (\url{http://chronicle.com/blognetwork/castingoutnines}).


\subsection*{Invited talks, workshops, and panel participation}
\begin{itemize}
	\item Invited keynote address, Kansas City Regional Math and Technology Expo, Kansas City, MO October 2015. 
	\item Invited talk/workshop, Project Advance Seminar, Syracuse and New York City, NY May 2015.
	\item Online seminar on flipped learning (title TBD), Magna Publications, March 2015.  
...
\begin{itemize}
	\item Faculty advisor, National Society of Collegiate Scholars GVSU chapter, 2014--present.
...
\begin{itemize}
	\item \textbf{Online offering of MTH 201: Calculus}, projected to be offered in Spring/Summer 2015. 
