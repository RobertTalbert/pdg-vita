...
\begin{itemize}
	\item \textbf{Mathematics:} Cryptography, category theory, applications of algebra to functional programming and computer science. 
	\item \textbf{Mathematics education:} Undergraduate mathematics education, flipped learning, integration of technology and programming with mathematics instruction, alternative grading practices. 
\end{itemize}
...
\begin{itemize}
	\item \emph{Flipped Learning in the University: A User's Guide}. Book in progress, Stylus Publications. Manuscript submitted and in review, publication in 2017.  
	\item Co-author, \textit{Instructional Practices Guide} forthcoming from Mathematical Association of America.
	\item Two chapters submitted to book on flipped learning in the university, to be published by Magna Publications. 
...
\begin{itemize}
	\item (\textit{Planning}) Workshop on flipped learning, St. Michael's College, Colchester, VT, March 2017. 
...
\begin{itemize}
	...
	\item Faculty Teaching and Learning Center Advisory Council, 2014--present; chair 2015--present. 
