...
Cryptography, category theory, computer science; scholarship of teaching and learning including flipped learning, blended learning, technology-enhanced instruction, and active learning spaces. 
...
\begin{itemize}
\item Associate Professor of Mathematics, Grand Valley State University 2011--present. Tenure granted May 2017; promotion to Full Professor currently in review. 
...
MTH 201 (Calculus); MTH 202 (Calclulus 2); MTH 203 (Calculus 3); MTH 210 (Communicating in Mathematics); MTH 225 (Discrete Structures for Computer Science 1); MTH 227 (Linear Algebra 1); MTH 312 (Cryptography and Privacy); MTH 315 (Discrete Mathematics); MTH 325 (Discrete Structures for Computer Science 2); MTH 350 (Modern Algebra); MTH 410 (Modern Algebra 2). 
...
\begin{itemize}
    \item ``Active learning spaces and their impact on teaching and learning: A literature review'' with Anat Mor-Avi (Illinois Institute of Technology). Paper in progress.
	\item Scholar-in-residence, Steelcase. Sabbatical for academic year 2017--2018. Projects in progress include active learning space paper (above) redesign of Steelcase corporate training materials, and scholarly presentations to Steelcase audiences. 
	\item Article: ``Video made the calculus star'' with Shelly Smith and Matthew Morena. Paper accepted and in press at \textit{PRIMUS: Problems, Resources, and Issues in Undergraduate Mathematics Studies}. 
	...
	\item Self-study: Statistical methods in social science; the Python SciPy stack. 
\end{itemize}
...
\begin{itemize}
\item Talbert R. (2017) Contributions to chapters in \emph{Instructional Practices Guide}, Mathematical Association of America (\url{http://bit.ly/2D1dfc8})
...
\item Talbert, R. (2016) ``Four Strategies for Effective Assessment in a Flipped Learning Environment''. In \emph{Flipping the College Classroom: Practical Advice for Faculty}, B. Honeycutt, editor, Magna Publications, 75--77.
...
\begin{itemize}
    \item Talbert, R. (2017) ``Myths and Facts About Flipped Learning''. \textit{EDUCAUSE Review}, 25 September 2017. \url{https://er.educause.edu/articles/2017/9/myths-and-facts-about-flipped-learning}
    \item Talbert, R. (2017) ``Three takeaways from Learning Spaces Symposium''. Steelcase corporate blog, \url{http://bit.ly/2D1HoYT}
...
\begin{itemize}
    \item ``Flipped Learning in Higher Education''. Webinar for Steelcase regional sales representatives, December 2017.
    \item ``Time, Space, and Activity: Redesigning College Classes for Flipped Learning Experiences''. Invited session, Merging Minds and Technology Conference, Boston, MA, November 2017.
    \item ``Active Learning: A Faculty Perspective''. Webinar for Steelcase Regional Education Leaders. November 2017.
    \item Interlocutor, session on Measuring Impact, Transitions Symposium at Steelcase, Grand Rapids, MI, September 2017. 
	\item ``Time, Space, and Activity: The Components of Learning''. Steelcase Lunch and Learn talk, Grand Rapids, MI, September 2017. 
...
\begin{itemize}
    \item Completed specialization certificate in Social Science Research Methods, Coursera. 
    \item Final Research Project (for Social Science Research Methods). Online course offered by Coursera through University of Amsterdam. Completed with certificate October 2017.
...
\begin{itemize}
    \item \textbf{Linear Algebra course redesign working group}. Currently serving ex officio on departmental working group to redesign MTH 227 and MTH 327. 
